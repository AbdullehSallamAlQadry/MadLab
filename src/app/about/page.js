  ...
  return(
    <main>
       <div className={`${sectionsStyle} bg-transparent gap-16`}>
        ...
        <div className={`${containersStyle} p-1`}>
      ...
      <div className={`${sectionsStyle} dark:bg-dark-bg-second bg-light-bg-second flex-col`}>
      ...
      <div className={`${sectionsStyle} flex-col dark:bg-dark-bg-second bg-light-bg-second`}>
        <div className="flex flex-col justify-between items-center p-15 w-200">
