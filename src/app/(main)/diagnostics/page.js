...
export default function Diagnostics() {
  ...
  return (
   <main className="bg-bg-second min-h-161 flex flex-col min-w-screen items-center rounded-t-4xl p-10">
    <h1 className="text-4xl mt-10">Explore MedMind AI Solutions</h1>
    <p className="text-xl text-text-second mt-6 mb-10">Diagnose become faster and more accurate with an expert-level, Advanced AI Detection Tools.</p>
    <div className="min-w-[70%]">
      {
        diagnosticsItems.map((group) => (
          <div key={group.category}  >
            <h1 className="text-3xl pl-5 mb-10">{group.category}</h1>
    ...
    <>
      <div className="flex items-center gap-5 justify-start mb-4">
        <div style={{ backgroundColor: group.color }} className={"w-10 h-10 flex items-center justify-center rounded-xl"}>
          <div className="relative w-[75%] pb-[100%]">
